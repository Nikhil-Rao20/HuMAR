...
def make_stage(*args, **kwargs):
    ...
    """
    return D2ResNet.make_stage(*args, **kwargs)


@BACKBONE_REGISTRY.register()
def build_d2_resnet_backbone(cfg, input_shape):
    """
    ...
    return D2ResNet(stem, stages, out_features=out_features, freeze_at=freeze_at)
